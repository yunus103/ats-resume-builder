...
function Experience({ onChange, data, onReset }) {
          ...
          {items.map((item) => (
							<div key={item.id} className={styles.experienceItem}>
								...
								<div className={styles.itemActions}>
									<button type="button" className={styles.edit} onClick={() => handleEdit(item)}><FaEdit /></button>
									<button type="button" className={styles.delete} onClick={() => handleDelete(item.id)}><FaTrash /></button>
								</div>
							</div>
          	))}
					</div>
